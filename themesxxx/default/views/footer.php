	...
	<div id="footer" class="clearingfix">
		...
		<div class="rapidxwpr floatholder">
			...
			<div class="footer-credits">
				...
				Powered by the &nbsp;<a href="http://www.ushahidi.com/"><img src="<?php echo url::file_loc('img'); ?>media/img/footer-logo.png" alt="Ushahidi" style="vertical-align:middle; width:70px;" /></a>&nbsp; Platform						
			</div>
			<!-- / footer credits -->
...
<li>
Didukung oleh: &nbsp;<a href="http://www.airputih.or.id/"><img src="<?php echo url::file_loc('img'); ?>media/img/logo_ap2.png" alt="Airputih" style="vertical-align:middle; width:80px;" /></a></li>
				<li><?php if($site_copyright_statement != '') { ?>
