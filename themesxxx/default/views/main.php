	...
	<li id="block-kusam">
		<div class="content-block">
			...
			<tr >
				...
				<td>  <?php require('/Applications/MAMP/htdocs/wp/wp-load.php'); query_posts('showposts=2');  if (have_posts()) : while (have_posts()) : the_post(); ?>
 				 ...
 				 <?php wp_reset_query(); ?>
<h1>Kolom lainnya</h1>
  <marquee><?php require('/Applications/MAMP/htdocs/wp/wp-load.php'); query_posts('offset=2');  if (have_posts()) : while (have_posts()) : the_post(); ?>
